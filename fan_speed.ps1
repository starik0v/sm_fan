...
D:\Arc\ipmi_supermicro\isc_ipmitool.exe -H IPMI_IP -U ADMIN -P 'PASSWORD' raw 0x30 0x70 0x66 0x01 0x01 0x05 

#Changing speed of letter fans
D:\Arc\ipmi_supermicro\isc_ipmitool.exe -H IPMI_IP -U ADMIN -P 'PASSWORD' raw 0x30 0x70 0x66 0x01 0x00 0x05